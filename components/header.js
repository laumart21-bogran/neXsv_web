...
.nex-nav{display:flex;align-items:center;gap:24px}.nex-nav a{text-decoration:none;font-family:'Inter',sans-serif;font-size:15px;font-weight:600;color:#2f4ea2;transition:.3s}.nex-nav a:hover{opacity:.75}
...
@media(max-width:950px){.menu-toggle{display:block}.nex-nav{position:fixed;top:72px;right:-100%;width:180px;display:flex;flex-direction:column;align-items:flex-start;padding:20px;gap:14px;background:white;border-radius:0 0 0 20px;box-shadow:-10px 0 30px rgba(0,0,0,.08);transition:.35s ease;z-index:999998}.nex-nav.active{right:0}.nex-nav a{font-size:14px}.nex-btn{width:100%;text-align:center;padding:12px;font-size:13px}}
